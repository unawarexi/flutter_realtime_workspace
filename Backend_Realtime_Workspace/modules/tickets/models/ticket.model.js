...
const ticketSchema = new mongoose.Schema(
  {
    ...
    tags: [{ type: String }],
    reporter: { type: mongoose.Schema.Types.ObjectId, ref: "UserInfo", required: true },
    assignee: { type: mongoose.Schema.Types.ObjectId, ref: "UserInfo" },
    watchers: [{ type: mongoose.Schema.Types.ObjectId, ref: "UserInfo" }],
    comments: [{
